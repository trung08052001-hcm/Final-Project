package com.example.finalproject.rvadapters
...
import com.example.finalproject.databinding.ShoedisplaymainItemBinding
...
class LikeAdapter(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            ShoedisplaymainItemBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false))
    }
